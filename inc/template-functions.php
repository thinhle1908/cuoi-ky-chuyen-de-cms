...
function jobscout_post_thumbnail() {
    ...
    if( is_home() || is_archive() || is_search() ){        
        ...
        if( has_post_thumbnail() ){                        
            echo '<figure class="post-thumbnail img-blog-thumbnail"><a href="' . esc_url( get_permalink() ) . '">';
...
function jobscout_entry_header(){ ?>
    <header class="entry-header entry-content-blog">
        <?php 
            ...
            if ( is_singular() ) :
                ...
                the_title( '<h2 class="entry-title title-entryblog"><a href="' . esc_url( get_permalink() ) . '" rel="bookmark">', '</a></h2>' );
            endif;        
        ?>
    </header>         
    <?php    
...
function jobscout_entry_content(){ 
    ...
    <div class="entry-content content-document-blog" itemprop="text">
		<?php
	...
	<footer class="entry-footer">
		<?php
            ...
            if( is_front_page() || is_home() || is_search() || is_archive() ){
                echo '<a href="' . esc_url( get_the_permalink() ) . '" class="readmore-link Read-content">' . esc_html( $readmore ) . '</a>';    
            }
